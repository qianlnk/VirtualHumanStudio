		...
		plans := []models.MembershipPlan{
			{
				...
				ASRTimesPerDay:          5,
				ASRMaxDuration:          60,
				DigitalHumanPerDay:      3,
				DigitalHumanMaxDuration: 30,
				ImageProcessPerDay:      5,
			},
			{
				Name:         "月度会员",
				...
				ASRTimesPerDay:          20,
				ASRMaxDuration:          180,
				DigitalHumanPerDay:      10,
				DigitalHumanMaxDuration: 120,
				ImageProcessPerDay:      10,
			},
			{
				Name:         "季度会员",
				...
				ASRTimesPerDay:          60,
				ASRMaxDuration:          300,
				DigitalHumanPerDay:      20,
				DigitalHumanMaxDuration: 300,
				ImageProcessPerDay:      20,
			},
			{
				Name:         "年度会员",
				...
				VoiceClonePerDay:        20,
				TTSWordsPerDay:          10000,
				ASRTimesPerDay:          120,
				ASRMaxDuration:          300,
				DigitalHumanPerDay:      50,
				DigitalHumanMaxDuration: 300,
				ImageProcessPerDay:      50,
			},
		}
